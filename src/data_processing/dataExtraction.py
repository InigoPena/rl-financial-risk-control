...
def download_and_process_gold_data(start_date='2000-01-01', end_date=None):
    """
...
def save_data(df, filename='gold_data_safepolicy.parquet'):
...
if __name__ == "__main__":
    ...
    df = download_and_process_gold_data(start_date='2015-01-01')
    
    # Display summary
    display_summary(df)
    
    # Save to CSV
    save_data(df, 'gold_data_safepolicy.parquet')
    ...
    print("\nNext steps:")
    print("  1. Load 'gold_data_safepolicy.parquet' in your gym-trading environment")
